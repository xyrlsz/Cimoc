...
public final class Constants {
    ...
    public static final String UPDATE_GITHUB_URL = "https://api.github.com/repos/xyrlsz/Cimoc/releases/latest";

    public static final String UPDATE_GITEE_URL = "https://gitee.com/api/v5/repos/xyrlsz/Cimoc/releases/latest";

    public static final String GITHUB_RELEASE_URL = "https://github.com/xyrlsz/Cimoc/releases";
    public static final String GITEE_RELEASE_URL = "https://gitee.com/xyrlsz/Cimoc/releases";
