...
import com.xyrlsz.xcimoc.databinding.FragmentStreamConfigBinding;
...
public class StreamConfigFragment extends BaseFragment implements DialogCaller {
    ...
    private FragmentStreamConfigBinding binding;
...
//        }
        binding = FragmentStreamConfigBinding.bind(requireView());
