package com.xyrlsz.xcimocob.ui.widget.preference;
...
import com.xyrlsz.xcimocob.ui.fragment.dialog.SliderDialogFragment;
...
public class SliderPreference extends Option implements View.OnClickListener {
    ...
    public void setValue(int value) {
        mPreferenceManager.putNumber(mPreferenceKey, value);
        mValue = value;
        mSummaryView.setText(String.valueOf(mValue));
    }
